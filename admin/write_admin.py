          ...
          <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-[#E3E8E3] dark:border-slate-800 rounded-3xl p-8 shadow-2xl">
            ...
            <form onSubmit={doLogin} className="space-y-4">
              ...
              <div>
                ...
                <input type="password" value={pwd} onChange={e => setPwd(e.target.value)} placeholder="••••••••" className="w-full px-4 py-3 rounded-xl bg-[#F6F8F6] dark:bg-slate-950 border border-[#E3E8E3] dark:border-slate-800 text-sm font-semibold outline-none focus:border-[#1A3827] dark:focus:border-[#A3E635]" />
              </div>
