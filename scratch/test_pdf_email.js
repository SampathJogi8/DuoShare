...
const txIdFormatted = '#TX-9012';
const txTitle = 'Electricity & Utility Invoice';
const formattedAmount = '₹3,890';
const txCategory = 'Utilities';
const txPaidBy = 'Sampath Jogi';
const roomDisplayName = 'ROOM-702';
const txDateTime = '25 Jul 2026 • 12:29 PM';
  ...
  <div style="background-color: #F8FAFC; border: 1px solid #E2E8F0; border-radius: 16px; padding: 20px 24px; margin-bottom: 28px;">
    ...
    <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
      <tr style="border-bottom: 1px solid #E2E8F0;">
        ...
        <td style="padding: 10px 0; text-align: right; font-weight: 800; color: #1A3827;">₹1,945</td>
      </tr>
      <tr>
      ...
      <table style="width: 100%; border-collapse: collapse;">
        <tr>
          ...
          <td style="padding-left: 10px; vertical-align: middle;">
            <div style="font-size: 13px; font-weight: 700; color: #1E40AF;">Electricity_Bill_July2026.pdf (PDF Document)</div>
            <div style="font-size: 11px; color: #3B82F6;">PDF receipt bill attached to expense entry</div>
          </td>
        </tr>
      </table>
    </div>
...
const messageText = `Tallyin Alert [${actionTitle}] (ID: ${txIdFormatted}): "${txTitle}" of ${formattedAmount} by ${txPaidBy} in Room ${roomDisplayName} on ${txDateTime}. Category: ${txCategory}, Split: ${txSplit}. [Receipt Attached: 1 PDF file]`;

async function sendPdfTest() {
  console.log(`Sending PDF receipt test email to ${targetEmail}...`);
...
sendPdfTest().catch(console.error);
